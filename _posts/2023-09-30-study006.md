---
layout : single
title : "[006] 조조장의 추석 선물#5 - 자료구조 문제 21~30"
categories : study
tag : [정처기,자료구조]
toc: true
toc_sticky: true
...
막판 스퍼트 땡긴다. 내일은 다른거 해야해서 남은 10문제 이 페이지에서 모두 끝낸다.
</span>
...
* 희소 행렬의 예
* ![img_2.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img_2.png?raw=true)
...
![img.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img.png?raw=true)
...
![tree.jpg](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/tree.png?raw=true)
...
![img_1.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img_1.png?raw=true)
...
* 1회전 : 3-5-8-4-9-1-6 
* 2회전 : 3-5-8-4-9-1-6 > 두번째 요소가 위치 이동이 필요없어 이대로 2회전 종료
* 3회전 : 3-4-5-8-9-1-6
* 4회전 : 3-4-5-8-9-1-6 > 다섯번째 요소가 위치 이동이 필요없어 이대로 4회전 종료
...
---
사실 상 연결 리스트에 대한 개념이 없어도. 이건 표에서 정답을... 대공개 한 느낌?
...
#### Linked List(연결 리스트)
  ...
  * 늘어선 노드의 중간지점에서도 자료의 추가와 삭제가 O(1)의 시간에 가능함
  * 배열이나 트리 구조와는 달리 특정 위치의 데이터를 검색해 내는데에는 O(n)의 시간이 걸림.
  * 연결 리스트 종류
    * 단일 연결 리스트
    * ![img_4.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img_4.png?raw=true)
    * 이중 연결 리스트
    * ![img_5.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img_5.png?raw=true)
    * 원형 연결 리스트
    * ![img_6.png](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/img_6.png?raw=true)
...
![gyul (2).jpg](https://github.com/ssomal62/ssomal62.github.io/blob/master/_posts/assets/images/2023-09-30-study006/gyul%20(2).jpg?raw=true)
